...
// //       {/* <div className="w-50 d-flex flex-column justify-content-center align-items-center bg-info"> */}
// //       {/* <div className="container w-50 d-flex flex-column justify-content-center align-items-center bg-light text-dark p-4 shadow rounded"> */}
// //       {/* <div className="container w-50 d-flex flex-column justify-content-center align-items-center bg-secondary text-white p-4 shadow rounded"> */}
...
const Signup = () => {
  const [formData, setFormData] = useState({
    ...
    confirmPassword: '',
    role: '',
    patientId: '', // for patients only
    organizationName: '', // for medical staff only
  });
  const navigate = useNavigate();
  const [error, setError] = useState('');
  const [successMessage, setSuccessMessage] = useState('');
  ...
  // Sample data for the pie chart
  const pieData = {
    labels: ['Astrocitoma T1', 'Astrocitoma T1C+', 'Astrocitoma T2', 'Carcinoma T1', 'Carcinoma T1C+', 'Carcinoma T2'],
    datasets: [
      {
        data: [30, 20, 25, 25, 30, 20], // Values for the pie chart
        backgroundColor: ['#FF6384', '#36A2EB', '#FFCE56', '#4BC0C0'],
        hoverBackgroundColor: ['#FF6384', '#36A2EB', '#FFCE56', '#4BC0C0'],
      },
    ],
