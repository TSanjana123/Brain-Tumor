...
const Organization = () => {
  ...
  // NEW: State to store fetched patient details
  ...
  const handleUpload = async (e) => {
    ...
    try {
      ...
      setSelectedPatientId('');
      setNewPatient({ name: '', gender: '', age: '', referredDoctor: '' });
      setPatientDetails(null); // Clear patient details after upload
    } catch (error) {
      console.error('Error uploading file:', error);
      alert('Failed to upload image.');
    }
  ...
  return (
    <div className="main-content2">
      ...
      <div className="content">
            ...
            <div>
              ...
              <select
                ...
                onChange={async (e) => {
                  ...
                  if (id) {
                    try {
                      const response = await axios.get(`http://localhost:5001/api/patient/${id}`);
        ...
        {/* NEW: Display selected patient details */}
        {patientDetails && (
          <div className="patient-details-card">
            ...
            <p><strong>Referred Doctor:</strong> {patientDetails.referredDoctor}</p>
          </div>
        )}
      </div>
    </div>
