  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (role === 'patient' && patientId) {
        ...
        localStorage.removeItem('patientId'); // Ensure it's removed if the role isn't patient
      }

      if (role === 'medicalStaff' && organizationName) {
        localStorage.setItem('organizationName', organizationName);
      } else {
        localStorage.removeItem('organizationName'); // Ensure it's removed if the role isn't medicalStaff
      }
